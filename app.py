...
- /predict endpoint that loads your .pkl and returns prob + label
...
MODEL_FILE = "endometriosis_hgb_model.pkl"   # change if needed
...
class PredictIn(BaseModel):
    features: Dict[str, float]   # { "FeatureName": value, ... }
